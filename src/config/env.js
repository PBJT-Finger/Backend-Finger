...
const validateEnv = () => {
  return cleanEnv(process.env, {
    ...
    CORS_ORIGINS: str({
      desc: 'Comma-separated list of allowed CORS origins (frontend origins, NOT backend port)',
      default: 'http://localhost:5555,http://localhost:3000,http://localhost:3333',
    }),
